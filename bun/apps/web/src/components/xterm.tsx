// https://github.com/Qovery/react-xtermjs/blob/main/src/xterm.tsx
import {
  type ITerminalAddon,
...
export interface XTermProps
  extends
    Omit<ComponentPropsWithoutRef<"div">, "onResize" | "onScroll">,
    UseXTermProps {
  instanceRef?: Ref<Terminal | null>;
}
...
export function XTerm({
  ...
  } else if (instanceRef !== null && instanceRef !== undefined) {
